 ...
 * @ORM\Entity(repositoryClass="Dictionary\ApiBundle\Repositories\WordRepository")
...
class Word
{
     ...
     * Add srbTranslate
     *
     * @param \Dictionary\ApiBundle\Entity\Eng2srb $srbTranslate
     * @return Word
     */
    public function addSrbTranslate(\Dictionary\ApiBundle\Entity\Eng2srb $srbTranslate)
    {
     ...
     * @param \Dictionary\ApiBundle\Entity\Eng2srb $srbTranslate
     */
    public function removeSrbTranslate(\Dictionary\ApiBundle\Entity\Eng2srb $srbTranslate)
    {
     ...
     * Add piles
     *
     * @param \Dictionary\ApiBundle\Entity\Piles $piles
     * @return Word
     */
    public function addPile(\Dictionary\ApiBundle\Entity\Piles $piles)
    {
        $this->piles[] = $piles;
     ...
     * @param \Dictionary\ApiBundle\Entity\Piles $piles
     */
    public function removePile(\Dictionary\ApiBundle\Entity\Piles $piles)
    {
